...
class DeliveryOfInvoiceTVController: UITableViewController {
    ...
    var devileryOfTypeList = [DevileryOfInvoiceModel]() {
        didSet {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return devileryOfTypeList.count
    }

    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "devileryOfInvoiceCell", for: indexPath)
